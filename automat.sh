...
# FR M6
sed -i "/m6france.m3u8/ c https://sv1.data-stream.top/$(wget -qO- "https://www.stream4free.tv/m6-live-streaming" | grep -oP 'https://sv1\.data-stream\.top/\K[^/]+(?=/hls/m6france\.m3u8' | head -n 1)/hls/m6france.m3u8/" geral.m3u
